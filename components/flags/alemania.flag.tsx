...
export const FlagAlemania = (props: SVGProps<SVGSVGElement>) => (
  <svg fill="none" height={15} width={21} xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <g mask="url(#a)">
      <path
        ...
        fill="#E00000"
      />
      <path clipRule="evenodd" d="M0 10h21v5H0v-5Z" fill="#FFCF00" fillRule="evenodd" />
      <path clipRule="evenodd" d="M0 0h21v5H0V0Z" fill="#000" fillRule="evenodd" />
      <path
